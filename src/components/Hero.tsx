export default function Hero() {
  return (
    <section className="bg-[#F5F3EE] px-6 py-16 md:py-24">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          {/* Search Bar */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center bg-white rounded-full shadow-md overflow-hidden border border-gray-200 max-w-xl">
            <div className="flex items-center gap-2 px-4 py-3 flex-1">
              <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-4.35-4.35M17 11A6 6 0 1 1 5 11a6 6 0 0 1 12 0z" />
              </svg>
              <input className="outline-none text-sm text-gray-700 w-full placeholder-gray-400" placeholder="Job title or keyword" />
            </div>
            ...
            <div className="flex items-center gap-2 px-4 py-3 flex-1">
              ...
              <input className="outline-none text-sm text-gray-700 w-full placeholder-gray-400" placeholder="Enter Zip Code" />
            </div>
            <button className="bg-[#C0392B] text-white text-sm font-semibold px-6 py-3 hover:bg-[#a93226] transition-colors shrink-0">
              Search Jobs
            </button>
          </div>
        ...
        <div className="flex-1 relative flex justify-center">
          <div className="relative w-full max-w-sm">
            ...
            {/* Hired badge */}
            <div className="absolute bottom-6 left-[-20px] bg-white rounded-2xl shadow-lg px-4 py-3 flex items-center gap-3 max-w-[200px]">
              ...
              <div>
                <p className="text-xs font-bold text-gray-900">Hired in 48 hours!</p>
